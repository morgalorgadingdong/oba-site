<footer class="col-12 vh-50 d-flex align-content-center py-5">
    <div class="col-12 d-flex justify-content-between align-content-center align-items-center">
        ...
        <div class="col-3 order-md-1 d-flex align-content-center flex-wrap">
            <p>Oregon Bicycle Adventures</p>
            <!-- <p>Name</p> -->
            <p>info@oregonbicycleadventures.com</p>
            <p>(503) 949-8766</p>
        </div>
        <div class="col-3 order-md-3 d-flex align-content-center flex-wrap justify-content-around">
