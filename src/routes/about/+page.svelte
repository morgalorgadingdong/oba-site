<div class="vh-60 hero col-12 d-flex flex-column justify-content-end">
    <div class="img-container">
        ...
        <img class="hero-img img" src="./img/about.jpg"/>
    </div>
    ...
    <div class="col-12 d-flex justify-content-between flex-wrap">
        ...
        <div class="col-12 col-lg-8 p-3">
            ...
            <!-- <ul>
                ...
                <li>Loves Carhartt but hates being "that guy" in all carhartt, so he cuts the patch off of all his Carhartt gear</li>
            </ul> -->
        </div>
    </div>
