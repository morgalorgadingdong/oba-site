export const manifest = {
	...
	_: {
		client: {"start":"_app/immutable/entry/start.2881875b.js","app":"_app/immutable/entry/app.bbeeeae4.js","imports":["_app/immutable/entry/start.2881875b.js","_app/immutable/chunks/index.fe5c5514.js","_app/immutable/chunks/singletons.935d42e4.js","_app/immutable/chunks/control.e7f5239e.js","_app/immutable/entry/app.bbeeeae4.js","_app/immutable/chunks/index.fe5c5514.js"],"stylesheets":[],"fonts":[]},
		nodes: [
			() => import('./nodes/0.js'),
			() => import('./nodes/1.js'),
			() => import('./nodes/2.js'),
		...
		routes: [
			...
			{
				id: "/api/createCheckoutLink",
				pattern: /^\/api\/createCheckoutLink\/?$/,
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/createCheckoutLink/_server.ts.js')
			},
			{
				id: "/api/updateStore",
				pattern: /^\/api\/updateStore\/?$/,
				params: [],
				page: null,
				endpoint: () => import('./entries/endpoints/api/updateStore/_server.ts.js')
			},
			{
				id: "/blog",
				pattern: /^\/blog\/?$/,
			...
			},
			{
				id: "/store/[storeItem]",
				pattern: /^\/store\/([^/]+?)\/?$/,
				params: [{"name":"storeItem","optional":false,"rest":false,"chained":false}],
