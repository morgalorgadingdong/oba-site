...
<section id="${"mission-section"}" class="${"col-12 d-flex justify-content-center flex-wrap py-5 mb-5 svelte-p0yttu"}">
    <div class="${"col-12 col-md-10 col-lg-8 col-xl-6"}"><h2>Our Mission</h2>
        <p id="${"mission-statement"}" class="${"pl-3 svelte-p0yttu"}">To deliver unforgettable tours that reveal <b class="${"svelte-p0yttu"}">Oregon&#39;s captivating beauty</b>, while spreading the <b class="${"svelte-p0yttu"}">inspiration and growth</b> that traveling by bicycle uniquely provides.</p></div></section>
